...
\begin{enumerate}
	...
	\begin{enumerate}[label*=\arabic*.]
		...
		\item $\first\df \first(\mathcal{A}_{\gamma})$
		\item $\last\df \last(\mathcal{A}_{\gamma})$
	...
	\begin{enumerate}[label*=\arabic*.]
		\item If $n>2$, compute the occurrence automaton $\mathcal{A}_{\gamma,R}$ from the expression $(\gamma_2\ror\cdots\ror\gamma_n)$ (by recursive application of this algorithm).
